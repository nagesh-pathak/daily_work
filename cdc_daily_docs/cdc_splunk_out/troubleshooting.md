# cdc.splunk-out — Troubleshooting
...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.splunk-out --tail=200
kubectl -n cdc describe pod -l app=cdc.splunk-out
kubectl -n cdc top pod -l app=cdc.splunk-out
```
