...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.grpc-in --tail=200
kubectl -n cdc describe pod -l app=cdc.grpc-in
kubectl -n cdc top pod -l app=cdc.grpc-in
```
