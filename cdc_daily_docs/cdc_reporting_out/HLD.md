# cdc.reporting-out — High Level Design


## Iteration 2026-08-12 14:00

### Context
cdc.reporting-out sits in the CDC pipeline as: **Egress (out)**.
Inputs: Kafka topics. Outputs: Reporting backend.
