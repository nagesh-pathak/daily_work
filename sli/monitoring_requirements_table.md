# CDC Monitoring Requirements Table

Based on SLI/SLO specifications and requirements.txt, this table maps monitoring requirements to service level indicators and objectives.
...
## Flow Status Monitoring Requirements
...
## Customer & Account Monitoring Requirements
...
## Container & Pod Monitoring Requirements
...
1. **CDCOnpremResourcesTimeseries.json** - Resource monitoring (CPU, Memory, Disk)
2. **CDCOnpremResourcesTables.json** - Host health and resource tables
3. **CDCOnpremFlowStatusTimeseries.json** - Flow status tracking
4. **CDCOnpremPodsResourcesTimeseries.json** - Pod resource monitoring
