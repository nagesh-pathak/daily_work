...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.http-out --tail=200
kubectl -n cdc describe pod -l app=cdc.http-out
kubectl -n cdc top pod -l app=cdc.http-out
```
