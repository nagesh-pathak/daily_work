# cdc.kafka.flow.processor — High Level Design


## Iteration 2026-07-10 17:00

### Context
cdc.kafka.flow.processor sits in the CDC pipeline as: **Processing**.
Inputs: Kafka topics. Outputs: Kafka topics.
