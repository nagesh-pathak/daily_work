# cdc.data.flow — High Level Design


## Iteration 2026-05-18 14:00

### Context
cdc.data.flow sits in the CDC pipeline as: **Pipeline orchestrator**.
Inputs: Kafka/gRPC. Outputs: Kafka/processors.
