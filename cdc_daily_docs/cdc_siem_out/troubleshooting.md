...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.siem-out --tail=200
kubectl -n cdc describe pod -l app=cdc.siem-out
kubectl -n cdc top pod -l app=cdc.siem-out
```
