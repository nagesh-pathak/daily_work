...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.appbase --tail=200
kubectl -n cdc describe pod -l app=cdc.appbase
kubectl -n cdc top pod -l app=cdc.appbase
```
