...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.data.flow --tail=200
kubectl -n cdc describe pod -l app=cdc.data.flow
kubectl -n cdc top pod -l app=cdc.data.flow
```
