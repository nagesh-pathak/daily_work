# cdc.reporting-out — Troubleshooting
...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.reporting-out --tail=200
kubectl -n cdc describe pod -l app=cdc.reporting-out
kubectl -n cdc top pod -l app=cdc.reporting-out
```
