...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.rest-out --tail=200
kubectl -n cdc describe pod -l app=cdc.rest-out
kubectl -n cdc top pod -l app=cdc.rest-out
```
