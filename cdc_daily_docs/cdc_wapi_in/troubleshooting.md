...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.wapi-in --tail=200
kubectl -n cdc describe pod -l app=cdc.wapi-in
kubectl -n cdc top pod -l app=cdc.wapi-in
```
