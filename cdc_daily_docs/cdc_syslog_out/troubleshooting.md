# cdc.syslog-out — Troubleshooting
...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.syslog-out --tail=200
kubectl -n cdc describe pod -l app=cdc.syslog-out
kubectl -n cdc top pod -l app=cdc.syslog-out
```
