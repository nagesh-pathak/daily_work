# cdc.infraservice — Troubleshooting
...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.infraservice --tail=200
kubectl -n cdc describe pod -l app=cdc.infraservice
kubectl -n cdc top pod -l app=cdc.infraservice
```
