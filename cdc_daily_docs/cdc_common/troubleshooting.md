...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.common --tail=200
kubectl -n cdc describe pod -l app=cdc.common
kubectl -n cdc top pod -l app=cdc.common
```
