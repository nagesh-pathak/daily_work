# cdc.flow.api.service — High Level Design


## Iteration 2026-05-21 14:00

### Context
cdc.flow.api.service sits in the CDC pipeline as: **Control plane**.
Inputs: API clients. Outputs: Flow registry.
