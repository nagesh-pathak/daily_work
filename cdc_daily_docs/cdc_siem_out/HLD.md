# cdc.siem-out — High Level Design


## Iteration 2026-07-30 11:00

### Context
cdc.siem-out sits in the CDC pipeline as: **Egress (out)**.
Inputs: Kafka topics. Outputs: SIEM collectors.
