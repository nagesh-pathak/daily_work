...
Useful commands:
```
kubectl -n cdc logs deploy/cdc.grpc-out --tail=200
kubectl -n cdc describe pod -l app=cdc.grpc-out
kubectl -n cdc top pod -l app=cdc.grpc-out
```
